...
namespace NeuroTOD
{
    ...
    public class HDRPIntegration : MonoBehaviour
    {
        ...
        /// 更新所有 HDRP 参数
        /// </summary>
        public void UpdateAll(float normalizedTime, TODPreset preset)
        {
            if (preset == null)
            {
                return;
        ...
        /// 更新天空参数
        /// </summary>
        public void UpdateSkyParameters(float normalizedTime, TODPreset preset)
        {
            if (preset == null)
            {
                return;
            ...
            {
                float skyIntensity = preset.skyLightIntensityCurve.Evaluate(normalizedTime);
        ...
        /// 更新雾效参数
        /// </summary>
        public void UpdateFogParameters(float normalizedTime, TODPreset preset)
        {
        ...
        /// 更新曝光参数
        /// </summary>
        public void UpdateExposureParameters(float normalizedTime, TODPreset preset)
        {
